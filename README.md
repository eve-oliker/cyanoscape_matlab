...
Adapted from the glakes project https://zenodo.org/records/21683614.

For in-depth information on utilizing scripts, visit the project wiki or https://docs.google.com/document/d/1_3koZInglCrY-6xyRqLDOWjNX8oAExrtmC8XpCKLm3w/edit?usp=sharing

READ ME
Eve Oliker, July 2026

Github Repository: https://github.com/eve-oliker/cyanoscape_matlab. 
This document contains MATLAB and Python scripts for the conversion of raw and processed in-situ water quality data into standardized formats (‘.sb’) for NASA SeaBASS.
...
Several of these scripts have been adapted from those developed by the glakes project https://doi.org/10.5281/zenodo.21683614 
...
Match station IDs Search all st
...
Construct the seabass file name
Using syntax: EXPERIMENT-NAME-DATATYPE_YYYYMMDDHHMM_RELEASE#.sb 
...
Create output file
Remove additional/ unnecessary header lines created by excel/csv
Reads contents cell-by cells
Find the true first and last line of the header
Preserve lines within header block (from /begin_header to /end_header)
Remove trailing commas
After the header, treat information as a string
Drop any blank/ missing values
...
Simplified standard pipeline for scripts ending in *_header_sb.m. 
...
Set input folder and find file with all data
...
metaRow and dataRows = create logical arrays, comparing station names using strcmpi (string compare case-insensitive)
...
Keep the output fields safe in siteTable.
